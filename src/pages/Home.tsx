          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
            ...
            >
              ...
              <motion.h1 
                ...
                className="text-5xl sm:text-6xl md:text-8xl font-display font-black uppercase italic tracking-tighter leading-[0.9] mb-6 md:mb-8"
              >
                Elite Workout <br />
              ...
              <motion.p 
                ...
                className="text-lg md:text-xl text-gray-400 mb-8 md:mb-10 leading-relaxed max-w-lg"
              >
        ...
        <section className="py-20 md:py-32 bg-black border-y border-white/5">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-6xl font-display font-black uppercase italic tracking-tighter mb-6 md:mb-8"
            >
            ...
            <motion.p 
              ...
              className="text-gray-400 text-base md:text-lg mb-10 md:mb-12 leading-relaxed max-w-2xl mx-auto"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 text-left">
              {[
                ...
                <motion.div 
                  ...
                  className="flex gap-4 p-5 md:p-6 bg-zinc-900/50 rounded-2xl border border-white/5 transition-colors cursor-default"
                >
                  <div className="w-6 h-6 rounded-full bg-red-600/20 flex items-center justify-center shrink-0 mt-1">
                    <CheckCircle2 className="w-4 h-4 text-red-600" />
                  </div>
                  <div>
                    <h3 className="text-white font-bold mb-1 tracking-tight text-sm md:text-base">{item.title}</h3>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 md:gap-8 mb-12 md:mb-20">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Link to="/workouts" className="text-red-600 font-bold uppercase tracking-widest flex items-center gap-2 hover:translate-x-2 transition-transform text-sm md:text-base">
                  View All Programs <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
                </Link>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                <motion.div 
                  ...
                  className="group relative h-[400px] md:h-[500px] overflow-hidden rounded-3xl border border-white/5 transition-transform duration-300 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(220,38,38,0.2)]"
                >
                  <img 
                    src={program.img} 
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-red-600 rounded-xl flex items-center justify-center mb-4 md:mb-6 shadow-xl shadow-red-600/40 group-hover:scale-110 transition-transform">
                      <program.icon className="w-5 h-5 md:w-6 md:h-6 text-white" />
                    </div>
                    <h3 className="text-2xl md:text-3xl font-black uppercase italic mb-2 md:mb-3">{program.title}</h3>
                    <p className="text-gray-300 text-xs md:text-sm mb-4 md:mb-6 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
                      {program.desc}
                    </p>
